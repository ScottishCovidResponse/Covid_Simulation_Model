...
public class LockdownComponentDeserialiser implements JsonDeserializer<LockdownComponent> {
    ...
    public LockdownComponentDeserialiser() {
        ...
        components.put("SocialDistancing", SocialDistancingComponent.class);
        components.put("Closure", ClosureComponent.class);
        components.put("SchoolToggle", SchoolToggleComponent.class);
        components.put("SchoolReturn", SchoolReturnComponent.class);
    }

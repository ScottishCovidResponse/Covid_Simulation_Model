...
public class CovidTest extends SimulationTest {
    ...
    public void testStepInfectionSymptomatic() {
        ...
        CovidParameters.get().diseaseParameters.probabilitySymptoms = new Probability(1.0);
    ...
    public void testStepInfectionAsymptomatic() {
        CovidParameters.get().diseaseParameters.probabilitySymptoms = new Probability(0);
